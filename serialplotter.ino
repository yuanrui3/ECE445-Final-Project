...
void setup() {
  ...
  //digitalWrite(2,HIGH);
  //digitalWrite(4,HIGH);
  Serial.println("Channel1,Channel2,Channel3,Channel4");
}
...
void loop(){
  ...
  if(deviceIDReturned == false){
    ...
    */
    ...
    ADS.WREG(CONFIG1, 0x95);
    //Serial.println("----------------------------------------------");
    ADS.WREG(CONFIG2, 0xD2);
    ADS.WREG(CONFIG3,0xE0);
    //ADS.WREG(CONFIG3,0b11101100);
  ...
  /*while(millis()<10000){
    ...
    counter++;
    if (counter==1000) digitalWrite(5,HIGH);
    if (counter==2000) digitalWrite(17,LOW);
    ...
    /*
    if (channels[1]<up&&channels[1]>down) y1=channels[1];
    if (channels[2]<up&&channels[2]>down) y2=channels[2];
    if (channels[3]<up&&channels[3]>down) y3=channels[3];
    if (channels[4]<up&&channels[4]>down) y4=channels[4];*/
    y1=channels[1];
    y2=channels[2];
    y3=channels[3];
    y4=channels[4];
